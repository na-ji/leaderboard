...
const periodLeaderboardQuery = `
  SELECT trainer_history.date                                                            AS date,
         ...
         trainer.vivillon - IFNULL(trainer_history.vivillon, 0)                          AS vivillon,
         trainer.showcase_max_size_first_place - IFNULL(trainer_history.showcase_max_size_first_place, 0) AS showcase_max_size_first_place,
         trainer.event_check_ins - IFNULL(trainer_history.event_check_ins, 0)            AS event_check_ins,
         trainer.parties_completed - IFNULL(trainer_history.parties_completed, 0)        AS parties_completed,
         trainer.total_route_play - IFNULL(trainer_history.total_route_play, 0)          AS total_route_play,
         ...
         trainer.unique_unown - IFNULL(trainer_history.unique_unown, 0)                  AS unique_unown,
         ...
         trainer.wayfarer_agreements - IFNULL(trainer_history.wayfarer_agreements, 0)    AS wayfarer_agreements,
         trainer.trainers_referred - IFNULL(trainer_history.trainers_referred, 0)        AS trainers_referred,
         ...
         trainer.jumbo_pokemon_caught - IFNULL(trainer_history.jumbo_pokemon_caught, 0)  AS jumbo_pokemon_caught,
         trainer.tiny_pokemon_caught - IFNULL(trainer_history.tiny_pokemon_caught, 0)    AS tiny_pokemon_caught,
         ...
         trainer.dex_gen8a - IFNULL(trainer_history.dex_gen8a, 0)                        AS dex_gen8a,
         trainer.dex_gen9 - IFNULL(trainer_history.dex_gen9, 0)                          AS dex_gen9,
