...
const periodLeaderboardQuery = `
  SELECT trainer_history.date                                              AS date,
         ...
         trainer.vivillon            - trainer_history.vivillon            AS vivillon,
         ...
         trainer.jumbo_pokemon_caught- trainer_history.jumbo_pokemon_caught AS jumbo_pokemon_caught,
         trainer.tiny_pokemon_caught - trainer_history.tiny_pokemon_caught AS tiny_pokemon_caught,
         ...
         trainer.dex_gen8a           - trainer_history.dex_gen8a           AS dex_gen8a,
